...
public class Details extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3111670296469331715L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Details\",\"namespace\":\"com.pojo.common.delta\",\"fields\":[]}");
   ...
   */
  public static com.pojo.common.delta.Details.Builder newBuilder() {
    return new com.pojo.common.delta.Details.Builder();
  }
   ...
   * @return A new Details RecordBuilder
   */
  public static com.pojo.common.delta.Details.Builder newBuilder(com.pojo.common.delta.Details.Builder other) {
    if (other == null) {
      return new com.pojo.common.delta.Details.Builder();
    } else {
      return new com.pojo.common.delta.Details.Builder(other);
    }
  }
   ...
   * @return A new Details RecordBuilder
   */
  public static com.pojo.common.delta.Details.Builder newBuilder(com.pojo.common.delta.Details other) {
    if (other == null) {
      return new com.pojo.common.delta.Details.Builder();
    } else {
      return new com.pojo.common.delta.Details.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Details>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pojo.common.delta.Details.Builder other) {
      super(other);
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pojo.common.delta.Details other) {
      super(SCHEMA$);
    }
